...
button_dot = Button(window, text=".", padx=22, pady=10, command=lambda: button_click('.'))
button_equal = Button(window, text="=", padx=48, pady=10, command=button_equal)

button_clear = Button(window, text="CLR", padx=68, pady=10, command=button_clear)
button_divide = Button(window, text="/", padx=23, pady=10, command=button_divide)

button_multiply = Button(window, text="X", padx=20.49, pady=10, command=button_multiply)

button_substract = Button(window, text="-", padx=22, pady=10, command=button_substract)
button_add = Button(window, text="+", padx=19, pady=10, command=button_add)
